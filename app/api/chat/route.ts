...
Feel free to reach out for opportunities or collaborations!`;
  ...
  if (lowerQuestion.includes("skill") || lowerQuestion.includes("tech")) {
    return `🛠️ **Prince's Technical Skills**
...
...and ${
  ...
  if (
    ...
    return `💼 **Prince's Professional Experience**
...
Want details about specific roles or achievements?`;
  ...
  // Generic fallback
  return `👋 Hi! I'm Prince's AI assistant. I can help you learn about:
