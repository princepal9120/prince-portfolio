...
| ------------------ | ---------------------- | ---------------------------------------------------------------- |
| **Job Channel**    | Main Routine → Workers | Used to send incoming tasks (jobs) to the waiting workers        |
| **Result Channel** | Workers → Main Routine | Used to send processed results back to the Main Routine (Fan In) |
